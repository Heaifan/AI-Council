...
(function (root) {
  ...
  T.test("TEST-129", "index.html 必须装配 D3 六席控制台全链路脚本、中文顶栏，且不得残留过期文案", function (ctx) {
    ...
    [
      ...
      "js/ui/harness/console-actions.js", "js/ui/harness/seat-local-config.js",
    ...
    ["meeting-persistence-ui.js", "meeting-runtime-view.js", "web-relay-view.js",
      "config-participant.js", "status-panel.js"].forEach(function (dead) {
    ...
    T.assert(html.indexOf('id="console-left"') >= 0 && html.indexOf('id="console-center"') >= 0 && html.indexOf('id="console-right"') >= 0,
      "必须有六席控制台左/中/右三区");
  });
